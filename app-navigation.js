...
(function () {
  ...
  if (location.pathname.endsWith('patient.html') && !document.querySelector('script[src="patient-context.js"]')) { const script = document.createElement('script'); script.src = 'patient-context.js'; document.body.appendChild(script); }
  ...
  const crm = {'dashboard':'crm.html','overview':'crm.html','home':'crm.html','patients':'patient.html','pacjenci':'patient.html','patient':'patient.html','calendar':'calendar.html','kalendarz':'calendar.html','clinical records':'patient.html','records':'patient.html','notatki':'note-create.html','dietetyka':'diet-plan.html','diet plans':'diet-plan.html','hermes':'hermes.html','documents':'documents.html','dokumenty':'documents.html','payments':'payments.html','płatności':'payments.html','roles':'roles.html','audit':'audit.html','knowledge':'knowledge.html','workspace modules':'crm-modules.html','module map':'crm-modules.html','new appointment':'appointment-create.html','teleconsultation':'teleconsult.html'};
